...
void TC_TextNode::drawImplementation(osg::RenderInfo& renderInfo) const 
{
  ...
  bool usingVertexBufferObjects = state.useVertexBufferObject(
      _supportsVertexBufferObjects && _useVertexBufferObjects);
  bool usingVertexArrayObjects =
...
void TC_TextNode::setText(const TC_GlyText&text) { _text = text; }


void TC_TextNode::drawImplementationSinglePass(
  ...
  bool usingVertexArrayObjects =
      usingVertexBufferObjects &&
      state.useVertexArrayObject(_useVertexArrayObject);
  bool requiresSetArrays = !usingVertexBufferObjects ||
                           !usingVertexArrayObjects ||
